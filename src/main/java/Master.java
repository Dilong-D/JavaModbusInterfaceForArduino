...
public class Master {
    ...
    public void sendDataToController(int t_cob, int f_cob){
    ...
    public void sendDataToLogger(int t_cob, int f_cob, int ub2, int tr){
   ...
   /* public static void main(String[] args) throws Exception {
        ...
        ipParameters.setHost("192.168.1.115");
        ipParameters.setPort(5555);
        ...
        try {
            ...
            // writeCoilTest(master, slaveId, 110, true);
             //writeRegister(master, slaveId, 420, 20);
            ...
            //BaseLocator<Number> locator = BaseLocator.holdingRegister(slaveId, 420, DataType.EIGHT_BYTE_INT_UNSIGNED);
    ...
    public void writeRegister(ModbusMaster master, int slaveId, int offset, int value) {
        try {
